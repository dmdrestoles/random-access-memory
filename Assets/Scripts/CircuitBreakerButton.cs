...
public class CircuitBreakerButton : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.CompareTag("Player") && coroutineButtonCooldown == null)
        {
            ...
            reply = SimonSays.simonSays.InputPress(buttonColor);
        }
        else
        {
            return;
        ...
        switch (reply)
        {
            ...
            case 'w':
                ...
                break;
            case 'f':
                switch (SimonSays.simonSays.levelsFinished)
                {
                    case 1:
                    ...
                    case 4:
                        ...
                        isGameFinished = true;
                        SimonSays.simonSays.FinishGame();
                        break;
                    case 5:
                        // Ignore
                        break;
